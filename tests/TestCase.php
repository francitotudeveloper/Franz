...
namespace Franz\Parcial1\Tests;

use Illuminate\Database\Schema\Blueprint;
use Franz\Parcial1\Tests\Models\User;
use Franz\Parcial1\Models\Role;
use Franz\Parcial1\Models\Permission;
...
abstract class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    {
        return [
            \Franz\Parcial1\Parcial1ServiceProvider::class,
        ];
    }
    ...
    {
        return [
            'Parcial1' => \Franz\Parcial1\Facades\Parcial1::class,
        ];
    }
}